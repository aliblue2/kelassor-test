...
const Landing = () => {
  ...
  return (
    <div className="flex relative container flex-col gap-16 md:gap-32">
      <AnimatedPath
        className="text-secondary-base absolute z-20 bg-opacity-20 md:left-5 md:top-12 top-[224px] scale-[85%] md:scale-100"
        ref={path1}
        id="path1"
        width={400}
        height={573}
