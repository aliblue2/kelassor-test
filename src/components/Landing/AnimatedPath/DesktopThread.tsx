...
import AnimatedPath, { AnimatedPathHandles } from "./AnimatedPath";
import Footstep from "@/components/Ui/Footstep";

//DesktopThread component
type DesktopThreadProps = { lastpath: RefObject<AnimatedPathHandles> };
const DesktopThread = ({ lastpath }: DesktopThreadProps) => {
  ...
  return (
    <div className="w-full absolute">
      <div className="relative container size-full">
        ...
        />
        <Footstep className="top-[500px] left-[345px] lg:block hidden absolute z-50" />
        <motion.div
        ...
        >
          ...
          />
          <Footstep className="absolute top-5 rotate-[80deg]" />
        </motion.div>
        <motion.div
          viewport={{ once: false, margin: "0px 0px -200px 0px" }}
          onViewportEnter={() => {
        ...
        >
          ...
          />
          <Footstep className="absolute top-40 left-[345px] rotate-[60deg]" />
        </motion.div>
        {/*todo:
        <motion.div
          viewport={{ once: false, margin: "0px 0px -200px 0px" }}
        ...
        */}
        <motion.div className="text-secondary-30 absolute z-10 top-[4414px] left-[154px] hidden lg:block">
          <AnimatedPath
            ref={lastpath}
            id="path9"
            width={262}
          ...
          />
          <Footstep className="absolute top-[150px] left-[105px] rotate-[90deg]" />
        </motion.div>
      </div>
    </div>
  );
