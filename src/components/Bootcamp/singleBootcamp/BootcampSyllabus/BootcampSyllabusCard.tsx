...
const BootcampSyllabusCard = ({ data , isPrimary }: BootcampSyllabusCardProps) => {
  return (
    <div className="bg-white w-[300px] shadow2 rounded-[30px] p-2 flex flex-col">
      <div className={`${isPrimary ? "bg-primary-30" : "bg-secondary-30"}text-center font-bold rounded-[22px] p-3 h-20 flex items-center justify-center`}>
        {data.course}
      </div>
